...
# WARNING
# The error message indicates that the 'sklearn' package is deprecated. You should use 'scikit-learn' 
# instead, which is the correct package name.
# 
# Use this command:
# python -m pip install scikit-learn
# 
# The 'sklearn' package on PyPI is just a legacy package that redirects to 'scikit-learn'. To avoid 
# issues and use the correct version, it's always better to use 'scikit-learn' directly.
