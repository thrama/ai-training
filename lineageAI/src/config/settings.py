...
class Settings(BaseSettings):
    ...
    edc_include_dst_links: bool = Field(default=True, description="Include destination links")
    edc_include_ref_objects: bool = Field(default=True, description="Include reference objects")
    ...
    # LLM Configuration
    # ========================================
    default_llm_provider: LLMProvider = Field(default=LLMProvider.GEMMA3)
    ...
    def is_tinyllama_available(self) -> bool:
        """Verifica se TinyLlama/Ollama e disponibile"""
        try:
            import requests
    ...
    def is_gemma3_available(self) -> bool:
        """Verifica se Gemma3/Ollama e disponibile"""
        try:
            import requests
